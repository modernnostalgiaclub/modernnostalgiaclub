  ...
  const DesktopNavLinks = () => {
    ...
    return (
      <>
        ...
        <a href="https://docs.google.com/forms/d/e/1FAIpQLScQm7rwO_R-O1Fg_0LR1_A3dyq_aPPB4JRJs6UvN63hBuprMQ/viewform" target="_blank" rel="noopener noreferrer" className={linkClasses}>
          Submit Music
        </a>
      ...
      <div className="w-full px-4 md:px-6 h-20 relative flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 shrink-0 ml-auto">
          <div className="hidden md:flex items-center gap-3">
            <a href="https://www.instagram.com/modernnostalgia.club/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/70 transition-colors" aria-label="Instagram">
              <Instagram className="h-4 w-4" />
            </a>
            <a href="https://www.threads.net/@modernnostalgia.club" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/70 transition-colors" aria-label="Threads">
            ...
            <a href="https://twitter.com/modernnostalgia" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/70 transition-colors" aria-label="Twitter">
