        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <ul className="text-muted-foreground leading-relaxed mt-4 list-disc pl-6 space-y-2">
              ...
              <li><strong>On-site forms:</strong> Applications, sponsorship inquiries, playlist submissions, and other form submissions are collected and stored directly on our own site</li>
            </ul>
            <p className="text-muted-foreground leading-relaxed mt-4">
