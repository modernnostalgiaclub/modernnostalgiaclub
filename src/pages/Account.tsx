            ...
            <motion.div key="identity" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-0">
                  <span className="h-10 px-3 flex items-center bg-muted border border-r-0 border-input rounded-l-md text-muted-foreground text-sm shrink-0">
                    /artist/
                  </span>
                  <Input
                    id="username"
                ...
                {formData.username && (
                  <p className="text-xs text-primary font-mono">
                    modernnostalgia.club/artist/{formData.username}
                  </p>
                )}
            ...
            <motion.div key="done" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }} className="space-y-6 text-center py-2">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  {formData.username
                    ? "Your artist profile is live and shareable."
                    : "Save your profile to make it live."}
                </p>
              </div>
...
export default function Account() {
  ...
  useEffect(() => {
    if (profile) {
      ...
      setFormData({
        ...
        bio: p.bio || '',
        pro: p.pro || '',
        has_publishing_account: p.has_publishing_account || false,
        publishing_company: p.publishing_company || '',
        writer_ipi: p.writer_ipi || '',
  ...
  const profileIsComplete = !!(profile as any)?.stage_name && !!(profile as any)?.username;
          ...
          >
            ...
            <Tabs defaultValue="profile" className="w-full">
              <TabsList className="mb-8 w-full justify-start overflow-x-auto">
                ...
                <TabsTrigger value="account">Account & Tier</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="profile" className="space-y-6">
                ...
                {/* Publishing info (advanced, collapsed below wizard) */}
                <motion.div variants={fadeIn}>
                ...
                <motion.div variants={fadeIn}>
                  <Card variant="elevated" className="relative overflow-hidden">
                    ...
                    <CardHeader className="relative">
                      ...
                      <CardDescription>Direct messaging with community members</CardDescription>
                    </CardHeader>
