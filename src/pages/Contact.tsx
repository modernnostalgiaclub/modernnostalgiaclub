    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="relative h-[50vh] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6">
          <h1 className="font-anton text-5xl md:text-7xl uppercase tracking-tight leading-[1.05] mb-4 text-white">
            Contact
          </h1>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                ...
                className="w-full h-14 text-lg font-medium bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg"
              >
