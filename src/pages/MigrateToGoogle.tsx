...
import { CheckCircle2, Loader2, ChevronRight, Star, Shield, Zap, Users2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        <div className="text-center space-y-3">
          ...
          >
            As a founding Patreon member, we're upgrading you to{' '}
            <strong className="text-foreground">Creative Economy Lab</strong> — our highest tier — for free, permanently.
          </motion.p>
        </div>
        ...
        >
          ...
          <p className="text-xs text-muted-foreground text-center leading-relaxed">
            Your Patreon account must be linked to your profile for us to verify your founding membership.
