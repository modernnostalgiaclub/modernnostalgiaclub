...
const fallbackResources = [
  ...
  { id: '9', title: 'Build Better Crates', description: 'Exclusive mashups, remixes, and DJ tools for building unique, professional-sounding crates.', url: 'https://buildbettercrates.com', category: 'Tools' },
];
